...
namespace Installer
    // This class is all the steps required to config a sheet

{
    partial class Config_Process
    {
        ...
        public static void  ProcessMain(string  sHost, string sUnid, string sTarget,string sEmail,string sVersionsw ) 
        {
