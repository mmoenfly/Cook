...
Set objFolder = objFSO.GetFolder(temp)  
 ...
 if Not objFSO.FolderExists(objDeskTop  &"\CCISpreadSheets") Then _
      objFSO.CreateFolder(objDeskTop  & "\CCISpreadSheets" ) 
...
For Each objItem in colItems
     ...
     sExt = sArr(1)
        IF sExt = "xlsm" or sExt = "xls" Then
            ...
            Set objLink = objShell.CreateShortcut(objDesktop & "\CCISpreadSheets\"  & File_Name &  ".lnk")
