...
namespace TestHarness.CookCustomers {
    ...
    public partial class GetCustomersService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public GetCustomersService() {
            this.Url = global::TestHarness.Properties.Settings.Default.TestHarness_CookCustomers_GetCustomersService;
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("GETCUSTOMERSReturn")]
        public string GETCUSTOMERS(string DBNAME, string VIEWNAME) {
        ...
        /// <remarks/>
        public void GETCUSTOMERSAsync(string DBNAME, string VIEWNAME) {
            this.GETCUSTOMERSAsync(DBNAME, VIEWNAME, null);
        }
        
        /// <remarks/>
        public void GETCUSTOMERSAsync(string DBNAME, string VIEWNAME, object userState) {
            ...
            this.InvokeAsync("GETCUSTOMERS", new object[] {
                        DBNAME,
                        VIEWNAME}, this.GETCUSTOMERSOperationCompleted, userState);
        }
